...
<div class="box-body box-profile">  
  <img class="profile-user-img img-responsive img-circle"  src="<?php echo Yii::app()->baseUrl.'/images/'.$model->foto ?>">
  ...
  <ul class="list-group list-group-unbordered">
    ...
    <li class="list-group-item">
      <b>Nombare de la Foto</b> <a class="pull-right"><?php echo $model->foto; ?></a>
    </li>
  </ul>
</div>
<!-- /.box-body -->
